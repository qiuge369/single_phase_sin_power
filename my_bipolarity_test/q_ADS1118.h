...
#define ADS1118_CS_H                P5OUT|=BIT3
#define ADS1118_CS_L                P5OUT&=~BIT3
#define ADS1118_SCLK_H              P5OUT|=BIT5
#define ADS1118_SCLK_L              P5OUT&=~BIT5
#define ADS1118_MISO_PINSTATE       (P1IN&BIT1)//1.0管脚的读取（要加括号，不然代码取决于运算优先级）
#define ADS1118_MOSI_H              P7OUT|=BIT5
#define ADS1118_MOSI_L              P7OUT&=~BIT5
